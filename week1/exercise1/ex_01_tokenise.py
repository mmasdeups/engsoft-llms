...
PARAGRAPH_EN = (
    "Although the tokenization process seems simple, it is actually "
    "a crucial step: it defines how the model interprets the meaning, "
    "context, and grammar of each word."
)
# Same paragraph, in your language. The default is Spanish; replace it with
# YOUR language for the exercise.
PARAGRAPH_MINE = (
    "Tot i que el procés de tokenització sembla senzill, en realitat "
    "és un pas crucial: defineix com el model interpreta el significat, "
    "el context i la gramàtica de cada paraula."
)
